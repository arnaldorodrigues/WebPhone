...
// This is a mock version of PhoneControl that doesn't dispatch getUserData
// It's used only for testing to avoid the Redux thunk middleware error
export const MockPhoneControl: React.FC = () => {
  ...
  // Removed the problematic useEffect that dispatches getUserData
